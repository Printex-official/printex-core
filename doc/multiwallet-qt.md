...
In order to support loading of multiple wallets in printex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is printex.cpp.
...
Changes to printex.cpp
----------------------
printex.cpp is the entry point into printex-qt, and as such, will require some minor modifications to provide hooks for
