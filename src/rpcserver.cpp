...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Printex server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Printex features */
        {"printex", "masternode", &masternode, true, true, false},
        {"printex", "listmasternodes", &listmasternodes, true, true, false},
        {"printex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"printex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"printex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"printex", "masternodedebug", &masternodedebug, true, true, false},
        {"printex", "startmasternode", &startmasternode, true, true, false},
        {"printex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"printex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"printex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"printex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"printex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"printex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"printex", "mnbudget", &mnbudget, true, true, false},
        {"printex", "preparebudget", &preparebudget, true, true, false},
        {"printex", "submitbudget", &submitbudget, true, true, false},
        {"printex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"printex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"printex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"printex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"printex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"printex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"printex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"printex", "checkbudgets", &checkbudgets, true, true, false},
        {"printex", "mnsync", &mnsync, true, true, false},
        {"printex", "spork", &spork, true, true, false},
        {"printex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"printex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use printexd, or the -server option to printex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> printex-cli " + methodname + " " + args + "\n";
}
