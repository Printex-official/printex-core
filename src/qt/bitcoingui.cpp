                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Printex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Printex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and printex: URIs)"));
    ...
    pioAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Printex Website"), this);
        pioAction->setToolTip(tr("Visit the Official Printex website"));
    bitcointalkAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Textile Print"), this);
        bitcointalkAction->setToolTip(tr("Printex Own Products To Print Textile"));
    shopAction = new QAction(QIcon(":/icons/bitcoin"), tr("&My Shop"), this);
        shopAction->setToolTip(tr("Printex Own Shop"));
    chainAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Printex Discord"), this);
        chainAction->setToolTip(tr("Join Printex Discord"));
    explorerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Printex Explorer"), this);
        explorerAction->setToolTip(tr("Printex Explorer"));
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Printex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Printex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Printex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Printex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Printex addresses"));
    ...
    openAction->setStatusTip(tr("Open a Printex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Printex Core help message to get a list with possible Printex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Printex Core client") + " " + networkStyle->getTitleAddText();
...
{
    QDesktopServices::openUrl(QUrl("http://printex.tech/"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("https://textile.printex.tech/"));
}
...
{
    QDesktopServices::openUrl(QUrl("http://explorer.printex.tech/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Printex network", "", count));
}
...
{
    QString strTitle = tr("Printex Core"); // default title
