...
/** Utility functions used by the Printex Qt UI.
 */
namespace GUIUtil
{
...
// Render Printex addresses in monospace font
...
// Parse "printex:" URI into recipient object, return true on successful parsing
